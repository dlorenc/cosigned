...
// +kubebuilder:webhook:verbs=create;update,path=/validate-cosigned-sigstore-dev-v1-policy,mutating=false,failurePolicy=fail,groups=cosigned.sigstore.dev,resources=policies,versions=v1,name=vpolicy.kb.io
